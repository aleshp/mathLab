        ...
        <div className="max-w-7xl mx-auto px-3 md:px-8 py-2 md:py-3 flex items-center justify-between gap-2 overflow-x-auto scrollbar-hide">
          ...
          <div className="flex items-center gap-1.5 md:gap-3 shrink-0">
            ...
            {user ? (
              <>
                  {/* === БАЛАНС МОНЕТ (НОВОЕ) === */}
                  <div className="flex items-center gap-1 md:gap-1.5 px-2 md:px-3 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-lg shrink-0 cursor-default" title="MathCoins (MC)">
